...
$lines.Add("# InnoForge Self-Review Report")
$lines.Add("")
...
if ($alive) {
    ...
    Write-Row "Server running" "[INFO]" "Not running - start with start-innoforge.bat"
...
$lines.Add("")
$lines.Add("---")
$lines.Add("*Auto-generated by InnoForge self-review script*")
